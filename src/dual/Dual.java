...
public class Dual {
    ...
    public static void testTabloide3(){
        System.out.println("[Funcion Objetivo]");
        FuncionObjetivo objetivo = new FuncionObjetivo(Caso.MAX, new Float[]{-4f, -12f, -18f});
        objetivo.imprimir();
        System.out.println("\n\n[Restricciones]");
        
        Restricciones restricciones = new Restricciones();
        restricciones.agregarRestriccion(Signo.MAYOR_IGUAL, new float[]{1f,0f,3f}, 3);
        restricciones.agregarRestriccion(Signo.MAYOR_IGUAL, new float[]{0f, 2f, 2f}, 5);
        restricciones.imprimir();
